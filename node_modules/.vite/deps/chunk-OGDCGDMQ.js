import {
  require_scheduler,
  require_tracing
} from "./chunk-7KSLXPQP.js";
import {
  require_object_assign,
  require_react
} from "./chunk-6ROAVPNT.js";
import {
    ...
    if (true) {
      module.exports = function $$$reconciler($$$hostConfig) {
        ...
        if (typeof Symbol === "function" && Symbol.for) {
          ...
          REACT_PORTAL_TYPE2 = symbolFor("react.portal");
...
function createRenderer(roots2) {
  function applyProps2(instance, newProps, oldProps = {}, accumulative = false) {
    ...
    for (i2 = 0; i2 < objectKeys.length; i2++) {
      if (is.equ(newProps[objectKeys[i2]], oldProps[objectKeys[i2]])) {
        sameProps.push(objectKeys[i2]);
      }
      if (is.fun(newProps[objectKeys[i2]]) && /^on(Pointer|Click|DoubleClick|ContextMenu|Wheel)/.test(objectKeys[i2])) {
        handlers.push(objectKeys[i2]);
      }
    }
    const leftOvers = [];
    if (accumulative) {
      ...
      for (i2 = 0; i2 < objectKeys.length; i2++) {
        if (!newProps.hasOwnProperty(objectKeys[i2])) {
          leftOvers.push(objectKeys[i2]);
        }
      }
    }
    ...
    for (i2 = 0; i2 < objectKeys.length; i2++) {
      if (toFilter.indexOf(objectKeys[i2]) > -1) {
        delete filteredProps[objectKeys[i2]];
      }
    }
    const filteredPropsEntries = Object.entries(filteredProps);
    for (i2 = 0; i2 < leftOvers.length; i2++) {
      if (leftOvers[i2] !== "children") {
        filteredPropsEntries.unshift([leftOvers[i2], DEFAULT + "remove"]);
      }
    }
...
var createRendererInstance = (gl, canvas) => isRenderer(gl) ? gl : new WebGLRenderer({
...
function render(element, canvas, {
  ...
  if (fiber && state) {
    ...
    if (size !== void 0 && !is.equ(lastProps.size, size))
      state.setSize(size.width, size.height);
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OGDCGDMQ.js.map
